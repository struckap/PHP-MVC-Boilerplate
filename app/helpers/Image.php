...
class Image {
     ...
     *
     */
    function crop($x1, $y1, $x2, $y2, $bg = ['255', '255', '255']) {
        ...
        $whiteBackground = imagecolorallocate($new, $bg[0], $bg[1], $bg[2]); 
     ...
     *
     */
    function resize($width, $height, $bg = ['255', '255', '255']) {
     ...
     *
     */
    function rotate($angle, $bg_color = '#ffffff') {
